...
" resizing windows
call tinykeymap#Map('windows', 'l', '<count1>wincmd >', {'desc': 'Increase width'})
call tinykeymap#Map('windows', 'h', '<count1>wincmd <', {'desc': 'Decrease width'})
call tinykeymap#Map('windows', 'k', 'resize +<count1>', {'desc': 'Increase height'})
call tinykeymap#Map('windows', 'j', 'resize -<count1>', {'desc': 'Decrease height'})
